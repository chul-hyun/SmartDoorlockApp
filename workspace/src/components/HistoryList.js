    ...
    render() {
        ...
        let historyTags = history.map(({name, state, authtime, id})=>(
            <View style={[styles.item]} key={id}>
                {(() => {
                if(state === 'warning'){
                    return <Text style={[styles.name, styles.itemText]}></Text>
                }else{
                    return <Text style={[styles.name, styles.itemText]}>{name}</Text>
                }
                })()}
                ...
                <View style={styles.state}>
                    ...
                    if(state === 'warning'){
                        return <Image source={icons.fireHome} style={styles.stateIcon} />
                    }
                    })()}
                </View>
            </View>
